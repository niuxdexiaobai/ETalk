 ...
 */
public class SdpTools {//Session Description Protocol (SDP). 

	/**
	 * Constructs a new SessionDescriptor from a given SessionDescriptor with
	 * only media types and attribute values specified by a MediaDescriptor
	 * Vector.
	 * <p>
	 ...
	 * (regardless any specified attributes).
	 * 
	 * @param sdp
	...
	/**
	 * Constructs a new SessionDescriptor from a given SessionDescriptor with
	 * only the first specified media attribute. /** Keeps only the first
