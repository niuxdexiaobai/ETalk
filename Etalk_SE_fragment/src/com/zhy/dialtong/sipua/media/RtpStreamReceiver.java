...
package com.zhy.dialtong.sipua.media;
...
import com.zhy.dialtong.sipua.net.RtpPacket;
import com.zhy.dialtong.sipua.net.RtpSocket;
import com.zhy.dialtong.sipua.net.SipdroidSocket;
 ...
 */
public class RtpStreamReceiver extends Thread {//ͨ����������
	...
	public static synchronized void ringback(boolean ringback) {
		if (ringback && ringbackPlayer == null) {
			...
			setMode(speakermode);
			enableBluetooth(PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(com.zhy.dialtong.sipua.ui.Settings.PREF_BLUETOOTH,
					com.zhy.dialtong.sipua.ui.Settings.DEFAULT_BLUETOOTH));
			...
			ringbackPlayer = new ToneGenerator(stream(),(int)(ToneGenerator.MAX_VOLUME*2*com.zhy.dialtong.sipua.ui.Settings.getEarGain()));
	...
	void restoreVolume() {
		...
		case AudioManager.MODE_IN_CALL:
				...
				if (oldring > 0) setStreamVolume(AudioManager.STREAM_RING,(int)(
						...
						com.zhy.dialtong.sipua.ui.Settings.getEarGain()*3), 0);
				track.setStereoVolume(AudioTrack.getMaxVolume()*
						(ogain = com.zhy.dialtong.sipua.ui.Settings.getEarGain()*2)
						,AudioTrack.getMaxVolume()*
						com.zhy.dialtong.sipua.ui.Settings.getEarGain()*2);
	...
	void saveSettings() {
		if (!PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(com.zhy.dialtong.sipua.ui.Settings.PREF_OLDVALID, com.zhy.dialtong.sipua.ui.Settings.DEFAULT_OLDVALID)) {
			...
			if (!PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).contains(com.zhy.dialtong.sipua.ui.Settings.PREF_OLDVIBRATE2))
			...
			Editor edit = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).edit();
			edit.putInt(com.zhy.dialtong.sipua.ui.Settings.PREF_OLDVIBRATE, oldvibrate);
			edit.putInt(com.zhy.dialtong.sipua.ui.Settings.PREF_OLDVIBRATE2, oldvibrate2);
			edit.putInt(com.zhy.dialtong.sipua.ui.Settings.PREF_OLDPOLICY, oldpolicy);
			edit.putInt(com.zhy.dialtong.sipua.ui.Settings.PREF_OLDRING, am.getStreamVolume(AudioManager.STREAM_RING));
			edit.putBoolean(com.zhy.dialtong.sipua.ui.Settings.PREF_OLDVALID, true);
			edit.commit();
		}
	}
	...
	public static void setMode(int mode) {
		Editor edit = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).edit();
		edit.putBoolean(com.zhy.dialtong.sipua.ui.Settings.PREF_SETMODE, true);
		edit.commit();
		AudioManager am = (AudioManager) Receiver.mContext.getSystemService(Context.AUDIO_SERVICE);
		if (Integer.parseInt(Build.VERSION.SDK) >= 5) {
	...
	public static void restoreMode() {
		if (PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(com.zhy.dialtong.sipua.ui.Settings.PREF_SETMODE, com.zhy.dialtong.sipua.ui.Settings.DEFAULT_SETMODE)) {
			Editor edit = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).edit();
			edit.putBoolean(com.zhy.dialtong.sipua.ui.Settings.PREF_SETMODE, false);
			edit.commit();
	...
	public static void restoreSettings() {
		if (PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(com.zhy.dialtong.sipua.ui.Settings.PREF_OLDVALID, com.zhy.dialtong.sipua.ui.Settings.DEFAULT_OLDVALID)) {
			...
			int oldvibrate = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getInt(com.zhy.dialtong.sipua.ui.Settings.PREF_OLDVIBRATE, com.zhy.dialtong.sipua.ui.Settings.DEFAULT_OLDVIBRATE);
			int oldvibrate2 = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getInt(com.zhy.dialtong.sipua.ui.Settings.PREF_OLDVIBRATE2, com.zhy.dialtong.sipua.ui.Settings.DEFAULT_OLDVIBRATE2);
			int oldpolicy = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getInt(com.zhy.dialtong.sipua.ui.Settings.PREF_OLDPOLICY, com.zhy.dialtong.sipua.ui.Settings.DEFAULT_OLDPOLICY);
			...
			Editor edit = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).edit();
			edit.putBoolean(com.zhy.dialtong.sipua.ui.Settings.PREF_OLDVALID, false);
			edit.commit();
	...
	void empty() {
		try {
			...
			if (!DialFragment.release) e2.printStackTrace();
		} catch (IOException e) {
		}
		try {
	...
	public void run() {
		boolean nodata = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(com.zhy.dialtong.sipua.ui.Settings.PREF_NODATA, com.zhy.dialtong.sipua.ui.Settings.DEFAULT_NODATA);
		keepon = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(com.zhy.dialtong.sipua.ui.Settings.PREF_KEEPON, com.zhy.dialtong.sipua.ui.Settings.DEFAULT_KEEPON);
		...
		ToneGenerator tg = new ToneGenerator(AudioManager.STREAM_VOICE_CALL,(int)(ToneGenerator.MAX_VOLUME*2*com.zhy.dialtong.sipua.ui.Settings.getEarGain()));
		track.play();
		System.gc();
		empty();
		lockFirst = true;
	...
	private static void println(String str) {
		if (!DialFragment.release) System.out.println("RtpStreamReceiver: " + str);
	}
