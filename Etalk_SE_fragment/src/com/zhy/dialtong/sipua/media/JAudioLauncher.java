...
{  
   ...
   {  log=logger;
      ...
      try
      {
    	 ...
    	 if (PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(com.zhy.dialtong.sipua.ui.Settings.PREF_CALLRECORD,
    			 com.zhy.dialtong.sipua.ui.Settings.DEFAULT_CALLRECORD))
  ...
  public boolean sendDTMF(char c){
   ...
   {
	  if (DialFragment.release) return;
