...
//			holder.pinyin.setVisibility(View.VISIBLE);
			//�滻��ɫ
			holder.number.setText(Html.fromHtml(list.get(position).getPhoneNum().replace(filterNum, "<font color='#74C741'>" + filterNum + "</font>")));
				...
				for (int i = 0; i < filterNum.length(); i++) {
					...
					if (TextUtils.isDigitsOnly(String.valueOf(c))) {
						...
						if (zms != null) {
							...
							formattedNumber = formattedNumber.replaceAll("%%", "<font color='#74C741'>");
