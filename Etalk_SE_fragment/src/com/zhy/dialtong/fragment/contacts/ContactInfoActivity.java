...
import com.zhy.dialtong.utils.widgets.ContactInfoItem;
...
public class ContactInfoActivity extends QuickCallActivity{
	...
	private static final String TAG = "[ZHANG]ContactInfoActivity";
	...
	private void refreshContact(){
		...
		try{
			...
			if (photo != null) {
				...
				mPhotoView.setImageResource(R.drawable.btn_head);
			}
		} catch (Exception e){
