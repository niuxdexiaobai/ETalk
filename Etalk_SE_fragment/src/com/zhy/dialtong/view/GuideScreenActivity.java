...
import com.zhy.dialtong.activity.QuickCallActivity;
import com.zhy.dialtong.firstenter.Login;
import com.zhy.dialtong.firstenter.Registration;
...
public class GuideScreenActivity extends QuickCallActivity{
	...
	private static final String TAG = "[ZHANG]GuideScreenActivity";
...
//		userObject.saveInBackground();
    ...
    class GuidePageAdapter extends PagerAdapter {  
        ...
        public Object instantiateItem(View view, int position) {  
            ...
            if(position == 2){
            	View registerButton = mViewList.get(position).findViewById(R.id.start_button);
        		if(registerButton != null){
        			registerButton.setOnClickListener(mStartOnClickListener);
        		}
        		View loginButton = mViewList.get(position).findViewById(R.id.login_button);
        		if(loginButton != null){
    ...
    private View.OnClickListener mStartOnClickListener = new View.OnClickListener() {
		...
		public void onClick(View arg0) {
			Intent i = new Intent(GuideScreenActivity.this, Registration.class);
	...
	private View.OnClickListener mLoginOnClickListener = new View.OnClickListener() {
		...
		@Override
		public void onClick(View arg0) {
			Intent i = new Intent(GuideScreenActivity.this, Login.class);
			GuideScreenActivity.this.startActivity(i);
			GuideScreenActivity.this.finish();
			GuideScreenActivity.this.overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
		}
